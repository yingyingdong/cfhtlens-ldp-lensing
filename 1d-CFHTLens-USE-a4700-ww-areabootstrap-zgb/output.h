...
int my_void_here_dmago(double (*pos)[6],double rcut,double zstep,double zmean_v,int nzbin_v,
                double mag_limit,double mask_ratio,double zmin,double zsteplg,double *DAzlg);

int my_void_here_method4o(double (*pos)[5],double rcut,double zstep,double zmean_v,int nzbin_v,
        double mag_limit,double mask_ratio,double zmin,double zsteplg,double *DAzlg);
...
void linklist_search_sub_pos2_pz_thread(LENS *Lens,double cen[2],SHEAR **shear,double rmax,double rmin,int *hoc,int *ll,double range[2][2],double step[2],
                double gstep[2],double zbin[2],int ntr[2],double zsteplg,int NDIV[2],int nfit,double *DAzlg,double zmean,int flagd,int flag_lg,int flag_wt,int flag_com,int flag_density,double pz);
